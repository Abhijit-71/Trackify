              ...
              <form className="p-6 md:p-8" onSubmit={handleSubmit}>
                <div className="flex flex-col gap-6">
                  ...
                  <div className="grid gap-3">
                    ...
                    <Input id="username" type="text" placeholder="Username" required name="username" onChange={handleChange} value={formData.username}/>
                  </div>
                  <div className="grid gap-3">
                    ...
                    <Input
                      id="password" type="password" name="password" required value={formData.password} onChange={handleChange} placeholder="Password"/>
                  </div>
